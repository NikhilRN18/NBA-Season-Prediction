...
def makeGraphs(data,seasonOpeners):
    ...
    for _,i in data.iterrows():
        currNode = TeamNode(_,i['gmDate'],i['teamAbbr'],i['teamDayOff'],i['opptAbbr'],i.iloc[3:46])
...
seasonGraphs,outcomes,node_mapping = makeGraphs(boxScores,seasonStartDates)
